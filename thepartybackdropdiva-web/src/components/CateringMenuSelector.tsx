...
export const CateringMenuSelector: React.FC = () => {
    ...
    const handleSaveCustom = async () => {
        ...
        try {
            ...
            console.error(e);
            toast.error('Failed to save custom package.');
        } finally {
                        ...
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 bg-white dark:!bg-gray-900 p-6 rounded-3xl border border-gray-100 dark:border-gray-800">
                            <div className="flex justify-between items-end mb-6">
                                ...
                                <button
                                    ...
                                    className="bg-gray-900 hover:bg-black dark:bg-gray-100 dark:hover:bg-white text-white dark:text-gray-900 px-6 py-2.5 rounded-xl text-sm font-bold transition-all disabled:opacity-50 border border-gold-500/50 hover:border-gold-500 shadow-[0_0_10px_rgba(212,175,55,0.2)] hover:shadow-[0_0_15px_rgba(212,175,55,0.4)]"
                                >
